...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Anhui Eastern Communication Group🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://boppfilmsale.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'BOPP, BOPET', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '皖ICP备11005402号', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://beian.miit.gov.cn/', // 备案查询链接，如果用了萌备等备案请在这里填写
  BEI_AN_GONGAN: process.env.NEXT_PUBLIC_BEI_AN_GONGAN || '皖ICP备11005402号', // 公安备案号，例如 '浙公网安备3xxxxxxxx8号'
  ...
  GREETING_WORDS:
    ...
    'Hi，Welcome Anhui Eastern Communication Imp.& Exp. Co., Ltd.🎉',
